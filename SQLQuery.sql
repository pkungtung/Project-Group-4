...
insert into Product values('tc3', 'Oreo Birthday Cake', 75, 'no', '../imgProduct/1oreo-birthday-cakeac15.png', 'Birthday')
insert into Product values('tc4', 'Vanilla Bean Birthday Cake', 69, 'no', '../imgProduct/1vanilla.jpg', 'Birthday')
insert into Product values('tc5', 'Dress Birthday Cakes for Girls', 96, 'no', '../imgProduct/1dress-birthday-cakes-for-girlsa8a4.png', 'Birthday')
...
insert into Product values('tc8', 'Ocean Anniversary Cake', 150, 'yes', '../imgProduct/2Ocean Anniversary Cake.jpg', 'Anniversary')
insert into Product values('tc9', 'Flower Cake', 200, 'yes', '../imgProduct/2Flower Cake.jpg', 'Anniversary')
insert into Product values('tc10', 'Silver and White Cake', 165, 'yes', '../imgProduct/2Silver and White.jpg', 'Anniversary')
insert into Product values('tc11', 'Our Engagement Cake', 300, 'yes', '../imgProduct/3Our Engagement Cake.jpg', 'Engagement')
insert into Product values('tc12', 'Mr&Mrs Cake', 180, 'yes', '../imgProduct/3mr and mrs.jpg', 'Engagement')
...
insert into Product values('tc16', 'Chocolate and Chelsea FC ', 125, 'yes', '../imgProduct/4chelsea.jpg', 'Marriage')
insert into Product values('tc17', 'Silhouette Inspired Cake ', 146, 'yes', '../imgProduct/4Silhouette Inspired Cake.jpg', 'Marriage')
insert into Product values('tc18', 'Cupcake Wedding Cakes', 123, 'yes', '../imgProduct/4Cupcake Wedding Cakes.jpg', 'Marriage')
insert into Product values('tc19', 'Rainbow Wedding Cake', 136, 'yes', '../imgProduct/4Rainbow Wedding Cake.jpg', 'Marriage')
insert into Product values('tc20', 'Red Roses Wedding Cake', 194, 'yes', '../imgProduct/4Red Roses Wedding Cake.jpg', 'Marriage')
insert into Product values('tc21', 'Vanilla and Strawberry Cake', 156, 'yes', '../imgProduct/2Vanilla and Strawberry Cake.jpg', 'Anniversary')
insert into Product values('tc22', 'Berry Cake', 96, 'no', '../imgProduct/1berry.jpg', 'Birthday')
insert into Product values('tc23', 'Dog-Cake', 256, 'yes', '../imgProduct/1Dog-Cake.jpg', 'Birthday')
insert into Product values('tc24', 'Star Berry Cake', 86, 'no', '../imgProduct/1Star.jpg', 'Birthday')
...
insert into Product values('tc32', 'Cream Berry Pie', 8, 'no', '../imgProduct/5creamberrypie.jpg', 'Dessert')
insert into Product values('tc33', 'Fruit', 10, 'no', '../imgProduct/5fruit.jpg', 'Dessert')
insert into Product values('tc34', 'Fruit Cake', 8, 'no', '../imgProduct/5fruit-cake.jpg', 'Dessert')
