        ...
        <c:when test="${!empty param.dangky}">
            ...
            <script language="JavaScript">
                ...
                function isValidUsername() {
                    ...
                    if (!testUsername) {
                        document.getElementById("failUser").innerHTML = "Account not available!";
                        return false;
                    } else {
                ...
                function isValidEmail() {
                    ...
                    if (!testmail) {
                        document.getElementById("failEmail").innerHTML = "Email not available!";
                        return false;
                    } else {
                ...
                function isValidPassword() {
                    ...
                    if (!testP) {
                        document.getElementById("password_error").innerHTML = "Password too short, require at least 6 character";
                        return false;
                    } else {
                ...
                function isValidPassword2() {
                    ...
                    if (password1.value !== password.value) {
                        document.getElementById("password1_error").innerHTML = "Password does not match!";
                        return false;
                    } else {
                            ...
                            <form method="POST" name="myform" action="../Controlle?action=register" onsubmit="return checkinput()">
                                ...
                                <div class="modal-content">
                                    <div class="modal-body">
                                        ...
                                        <div class="checkbox">
                                            <label>
                                                <input type="checkbox" name="checkbox" style="display: inline;">  </br></br>Agree with our term and regulation!
                                            </label>
                                        </div>						      				      
                                    </div>
