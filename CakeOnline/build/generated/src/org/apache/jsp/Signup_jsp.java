  ...
  private boolean _jspx_meth_c_otherwise_0(javax.servlet.jsp.tagext.JspTag _jspx_th_c_choose_0, PageContext _jspx_page_context)
    ...
    if (_jspx_eval_c_otherwise_0 != javax.servlet.jsp.tagext.Tag.SKIP_BODY) {
      do {
        ...
        out.write("                                            <td><input type=\"text\" id=\"login\" name=\"username\" placeholder=\"Enter your name\" onkeyup=\"isValidUsername() / > < /td>\n");
        out.write("                                            < p id =\"failUser\" style=\"color: red\"></p> \n");
        out.write("\n");
        out.write("                                        </tr>\n");
        out.write("                                        <tr>\n");
        out.write("                                            <td><label for=\"email\">E-mail</label></td>\n");
        out.write("                                            <td><input type=\"text\" id=\"email\" name=\"email\" id=\"fname\" placeholder=\"Enter your email\" onkeyup=\"isValidEmail() / > < /td>\n");
        out.write("                                            < p id =\"failEmail\" style=\"color: red\"></span>\n");
        out.write("                                        </tr>\n");
        out.write("\n");
        out.write("                                        <tr>\n");
        out.write("                                            <td><label for=\"password\">Password</label></td>\n");
        out.write("                                            <td><input name=\"password\" type=\"text\" id=\"password\" placeholder=\"Password\" onkeyup=\"isValidPassword() / > < /td>\n");
        out.write("                                            < p id =\"password_error\" style=\"color: red\"></span>\n");
        out.write("                                        </tr>\n");
        out.write("                                        <tr>\n");
        out.write("                                            <td><label for=\"confirmpass\">Confirm<br />Password</label></td>\n");
        out.write("                                            <td><input type=\"text\" id=\"confirmpass\" name=\"confirmpass\" placeholder=\"Retype Password\" onkeyup=\"isValidPassword2() / > < /td>\n");
